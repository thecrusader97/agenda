                ...
                <div class="container-fluid">
                    ...
                    <table class="table">
                        ...
                        <?php
                            ...
                            <td>
                            <a href="edit_rapat.php?id=<?php echo $data['id'] ?>" class="btn btn-warning text-white">Edit</a>
			                <a href="delete_rapat.php?id=<?php echo $data['id'] ?>" class="btn btn-danger">Hapus</a>
                            </td>
