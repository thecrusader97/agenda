            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Monitoring kunjungan</h1>
                        <!-- <a href="add_kunjungan.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            include '../config.php';
                            $no = 1;
                            $get_data = mysqli_query($conn,"SELECT * FROM kunjungan");
