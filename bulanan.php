            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="add_Bulanan.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            include 'config.php';
                            $no = 1;
                            $get_data = mysqli_query($conn,"SELECT * FROM bulanan");
			                ...
			                <a href="delete_bulanan.php?id=<?php echo $data['id'] ?>" class="btn btn-danger">Hapus</a>
                            </td>
